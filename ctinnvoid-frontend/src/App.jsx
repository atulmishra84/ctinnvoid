  ...
  return(
    <div className="page">
      ...
      <div className="sgrid c3 gap">
        ...
        <div className="sc"><div className="sc-glow" style={{background:"#00F5D4"}}/><div className="slbl">Avg Confidence</div><div className="sval" style={{color:"#00F5D4"}}>{Math.round(ROLES.reduce((s,r)=>s+r.conf,0)/ROLES.length)}%</div><div className="ssub">Clustering accuracy</div></div>
      </div>
      ...
      <div className="ph">
        <div className="phtop">
          <div>
            ...
            <div className="psub">Trace how identities flow through groups, applications and entitlements</div>
          </div>
          <div className="pact">
            <div className="sgrid" style={{gridTemplateColumns:"repeat(3,1fr)",gap:10,margin:0}}>
              <div className="sc" style={{padding:"10px 16px"}}><div className="slbl">Nodes</div><div className="sval" style={{fontSize:22,color:"var(--violet)"}}>{LIN_NODES.length}</div></div>
              <div className="sc" style={{padding:"10px 16px"}}><div className="slbl">Edges</div><div className="sval" style={{fontSize:22,color:"var(--teal)"}}>{LIN_EDGES.length}</div></div>
